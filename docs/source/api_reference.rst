...
This is the comprehensive API reference for the aBIDSkit package. The following sections provide
detailed information about the various modules, classes, and functions available in aBIDSkit.

Introduction
------------

aBIDSkit provides a Python interface for working with BIDS (Brain Imaging Data Structure) datasets.
